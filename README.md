...
**SCAYS 1.3** 是一个从小红书采集的中文青少年情感语料库，目前包含 **30,182 条** 句子级标注数据（三分类：负面 / 中性 / 正面），覆盖 **2 个维度、46 个关键词**（身份锚点 17 个 + 周期节律 29 个）。
...
#### 维度 2：周期节律（Temporal Rhythm）— 22,178 条

| 类别 | 数量 | label | 说明 |
|------|------|-------|------|
| 显性情绪句子 (normal) | 5,116 条 | 1 | 含明确情绪词汇 |
| 隐含情绪句子 (invisible) | 520 条 | 1 | 无情绪词但有隐含情绪 |
| 正面情绪句子 (positive) | 137 条 | 2 | 正面情绪表达 |
| 中性句子 (neutral) | 4,202 条 | 0 | 无情绪表达 |
| 小计 | **22,178 条** | | 29 个关键词（含高考热点 3 个） |
...
- **采集范围**：基于维度 1（身份锚点）和维度 2（周期节律）设计的 46 个定向关键词
...
- [x] ~~扩大数据规模：从 8,000 条扩展到 30,000+ 条~~ ✅ 已完成（v1.3，30,182 条）
- [x] ~~增加采集关键词：覆盖维度 2（周期节律）的全部 29 个关键词~~ ✅ 已完成
- [ ] 继续扩展：覆盖维度 3-7 的关键词，目标 50,000+ 条
- [ ] 完善隐含情绪标注：引入 LLM 辅助 + 人工双审校，提高标注质量
- [x] ~~发布 BERT 三分类模型（验证集准确率 96%）~~ ✅ 已更新
