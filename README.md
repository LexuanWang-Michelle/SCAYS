...
**SCAYS 1.3** 是一个从小红书采集的中文青少年情感语料库，目前包含 **33,636 条** 句子级标注数据（三分类：负面 / 中性 / 正面），覆盖 **2 个维度、46 个关键词**（身份锚点 17 个 + 周期节律 29 个）。
